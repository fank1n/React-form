...
const Home = () => {
  const { inStock, cartInfo, setCartInfo, handlerPutCart, succesLogin, setSuccesLogin, formValid, setFormValid} = useContext(Context);
    ...
    <div id="items-container">
      <div className="items">
        {inStock.sort((a,b) => a.id - b.id).map((product) => (
          ...
          :
            <p>
              Чтобы добавить товар, <br/>авторизируйтесь
            </p>
          }
